...
let selectedRole = undefined; // Start with undefined for unified login
...
async function handleLogin() {
  ...
  // Pass selectedRole (can be undefined for unified login, or specific role if selected)
...
async function redirectToDashboard(role) {
  ...
  } else if (role === 'security' || role === 'coordinator') {
  ...
  setTimeout(async () => {
    ...
    else if (role === 'security' || role === 'coordinator') await loadSecurityDashboard();
